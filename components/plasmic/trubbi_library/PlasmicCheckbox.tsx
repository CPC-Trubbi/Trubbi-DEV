...
import * as sty from "./PlasmicCheckbox.module.css"; // plasmic-import: uyNuy-uGsrz/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 5V8ENcyLww6/icon
import IndeterminateIcon from "./icons/PlasmicIcon__Indeterminate"; // plasmic-import: UJJfzR2-HAk/icon
