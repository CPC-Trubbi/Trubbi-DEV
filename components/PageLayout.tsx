...
} from "./plasmic/trubbi_is/PlasmicPageLayout";
...
interface PageLayoutProps extends DefaultPageLayoutProps {}

function PageLayout_(props: PageLayoutProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicPageLayout root={{ ref }} {...props} />;
}

const PageLayout = React.forwardRef(PageLayout_);
